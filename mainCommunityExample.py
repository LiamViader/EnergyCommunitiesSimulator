...
print("COST of QuotaConsumptionSharing With reassign based on shares:",community.get_simulated_community().get_total_community_cost())
...
print("COST of QuotaConsumptionSharing With reassign based on proportion:",community.get_simulated_community().get_total_community_cost())
community.set_sharing_method(SequentialSharing())
community.shareSimulatedEnergies()
print("COST of SequentialSharing:",community.get_simulated_community().get_total_community_cost())
community.set_sharing_method(VirtualNetBilling())
community.shareSimulatedEnergies()
print("COST of VirtualNetBilling:",community.get_simulated_community().get_total_community_cost())
community.set_sharing_method(Quota())
community.shareSimulatedEnergies()
print("COST of Quota:",community.get_simulated_community().get_total_community_cost())
